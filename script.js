class AudioController {
  constructor() {
    this.bgMusic = new Audio('Assets/Audio/Assets_Audio_Marhaba .mp3');
    ...
    this.gameOverSound = new Audio('Assets/Audio/Assets_Audio_gameOver.mp3');
...
class PickAndChoose {
  ...
  flipCard(card) {
    if (this.canFlipCard(card)) {
      ...
      this.totalClicks++;
      this.ticker.innerText = this.totalClicks;
      if (this.totalClicks === 40) this.OutOFFlips();
